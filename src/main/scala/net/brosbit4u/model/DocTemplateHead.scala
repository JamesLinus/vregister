...
object DocTemplateHead extends MongoDocumentMeta[DocTemplateHead] {
  ...
  def create = DocTemplateHead(ObjectId.get, "", "d", "", "",  new ObjectId("000000000000000000000000"))
}

case class DocTemplateHead(var _id: ObjectId, var title:String, var docTyp:String,
