...
package net.brosbit4u {
  package model {
    ...
    object ClassModel extends ClassModel with LongKeyedMetaMapper[ClassModel] {
      override def fieldOrder = List(id, level, letters, description, teacher)
    }
